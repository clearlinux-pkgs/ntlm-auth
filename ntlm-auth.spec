...
%prep
%setup -q -n ntlm-auth-1.5.0
cd %{_builddir}/ntlm-auth-1.5.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635777594
...
cp %{_builddir}/ntlm-auth-1.5.0/LICENSE %{buildroot}/usr/share/package-licenses/ntlm-auth/3feb94e218ec9cc73b84cf413325044398ed1ebb
